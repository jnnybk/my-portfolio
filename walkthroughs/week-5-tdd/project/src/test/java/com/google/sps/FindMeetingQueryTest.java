...
public final class FindMeetingQueryTest {
  ...
  public void optionalAttendeeWithAllDayEvent() {
    // Have each person (A and B) have different events and an optional attendee C.
    // We should see three options because attendee C is optional.
    //
    // Events  : |--------------C--------------|
    //                 |--A--|     |--B--|
    // Day     : |-----------------------------|
  ...
  @Test
  public void optionalAttendeeWithShortEvent() {
    Collection<Event> events = Arrays.asList(
      new Event("Event 1", TimeRange.fromStartDuration(TIME_0800AM, DURATION_30_MINUTES),
          Arrays.asList(PERSON_A)),
      new Event("Event 2", TimeRange.fromStartDuration(TIME_0900AM, DURATION_30_MINUTES),
  ...
  public void justEnoughRoomWithOptionalAttendee() {
    Collection<Event> events = Arrays.asList(
        ...
        new Event("Event 2", TimeRange.fromStartEnd(TIME_0900AM, TimeRange.END_OF_DAY, true),
            Arrays.asList(PERSON_A)),
        new Event("Event 3", TimeRange.fromStartEnd(TIME_0800AM, TIME_0845AM, false),
            Arrays.asList(PERSON_C)));
  ...
  public void noMandatoryAttendees() {
    Collection<Event> events = Arrays.asList(
      new Event("Event 1", TimeRange.fromStartDuration(TIME_0900AM, DURATION_60_MINUTES),
          Arrays.asList(PERSON_A)),
      new Event("Event 2", TimeRange.fromStartDuration(TIME_1000AM, DURATION_90_MINUTES),
          Arrays.asList(PERSON_B)));
  ...
  public void noMandatoryAttendeesNoGaps() {
    Collection<Event> events = Arrays.asList(
      new Event("Event 1", TimeRange.fromStartEnd(TimeRange.START_OF_DAY, TIME_1130AM, false),
          Arrays.asList(PERSON_A)),
      new Event("Event 2", TimeRange.fromStartEnd(TIME_1130AM, TimeRange.END_OF_DAY, true),
          Arrays.asList(PERSON_B)));
  ...
  @Test
  public void multipleOptionalAttendees() {
    Collection<Event> events = Arrays.asList(
      ...
      new Event("Event 2", TimeRange.fromStartEnd(TIME_0800AM, TIME_0830AM, false),
        Arrays.asList(PERSON_B)),
      new Event("Event 3", TimeRange.fromStartEnd(TIME_0930AM, TIME_1130AM, false),
        Arrays.asList(PERSON_C)));
